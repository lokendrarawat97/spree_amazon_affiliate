module Spree
  module Amazon
    ...
    class ProductCollection < Array
      ...
      # TODO: remove 1,1,0 old defaults
      ...
      alias :limit_value :per_page # Kaminari uses limit_value
      ...
      class << self
        ...
        def build(options = { })
          ...
          @collection.total_entries = @collection.num_pages = build_total_pages(options[:total_entries], @max_total_pages)
        ...
        def build_total_pages(num_pages, max_total_pages)
          if num_pages.to_i >= max_total_pages.to_i
            max_total_pages.to_i
          elsif num_pages.to_i == 0
            1
          else
            num_pages.to_i
          end
